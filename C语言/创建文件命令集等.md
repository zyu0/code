...
![image-20201231163637287](assets/image-20201231163637287.png)

命名不支持特殊符号

![image-20201231173849642](assets/image-20201231173849642.png)

![image-20201231173946647](assets/image-20201231173946647.png)

通过创建C++文件改后缀名

![image-20201231174053566](assets/image-20201231174053566.png)

![image-20201231175105218](assets/image-20201231175105218.png)

直接打print不管用，需要头文件定义

![image-20201231180047546](assets/image-20201231180047546.png)

Main函数是C语言程序的起始执行点。每一个C程序必须有且仅有一个main函数，它是由程序员提供的。



2.2.4 system（“pause")和getchar的区别
...
（2）system("pause"):即让操作系统来暂停该程序进程的执行，同时程序运行到此语句处时，会在程序的窗口上显示“Press any key tocontinue.”也就是“按任意键继续.…”，即等待用户按下任意一个按键使该程序从暂停状态返回到执行状态继续从刚才暂停的地方开始执行。
...
关闭进程 `taskkill /f /im QQ.exe`

![image-20201231183808073](assets/image-20201231183808073.png)
