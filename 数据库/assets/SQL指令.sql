...
--02 数据表的操作
    ...
    -- 清空表-删除内容，用来当表显示错误时重新写入，例如id不从1开始计数
...
+--------+-------------------------+------+-----+---------+----------------+
        ...
        -- insert into students values(null, '打不完', 19,1.75, '女', 2);
	...
	-- 数据库备份与恢复(了解)
		-- mysqldump –uroot –p 数据库名 > python_db.sql;
		-- mysql -uroot –p 新数据库名 < python_db.sql;
